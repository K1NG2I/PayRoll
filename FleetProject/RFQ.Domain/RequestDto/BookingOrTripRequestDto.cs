...
namespace RFQ.Domain.RequestDto
{
    public class BookingOrTripRequestDto
    {
        ...
        public DateTime? EWayBillExpiryDate { get; set; } = DateTime.Now;   
        public int? ConsignerId { get; set; }
        public string? ConsignerName { get; set; }
        public int? ConsigneeId { get; set; }
        public string? ConsigneeName { get; set; }
        public int? TransitDays { get; set; }
        public DateTime? EDD { get; set; } = DateTime.Now;
        ...
        public List<BookingInvoiceRequestDto> BookingInvoiceDetailList { get; set; }
    }
}
