...
$(document).ready(function () {
    ...
    $(document).on('click', 'th.sortable', function () {
        ...
        FetchDataForTable('tableuser', '/Home/ViewUserList', orderColumn, orderDir.toUpperCase(), 'EditUser', 'DeleteUser', 'userId', listingQuery);
    });
    Initialization();
    ...
    UpdateUser();
    // Read listingQuery from querystring if present
    listingQuery = GetQueryParam('listingQuery') || '';
...
function FetchUser() {
    ...
    FetchDataForTable('tableuser', '/Home/ViewUserList', null, null, 'EditUser', 'DeleteUser', 'userId', listingQuery);
}
